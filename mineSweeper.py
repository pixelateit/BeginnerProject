...
class Board:
    def __init__(self, dim_size, num_bombs):
        # let's keep track of the parameters.
    ...
    def __str__(self):
        ...
        # first let's create a new array that represent what the user would see
        ...
        for idx, col in enumerate(indices):
            _format = "%-" + str(widths[idx]) + "s"
            cells.append(_format % col)
