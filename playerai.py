...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        if state.current_winner == other_player:
            # we should return position and score to keep track of it for minimax to work
        ...
        for possible_move in state.available_moves():
            # Step 1: make a move, try that that spot
            ...
            sim_score["position"] = possible_move  # otherwise it will get messed up from the recursion part
